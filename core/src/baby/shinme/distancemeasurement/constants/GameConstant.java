package baby.shinme.distancemeasurement.constants;

/**
 * Created by jichoul on 2017-05-07.
 */
public class GameConstant {
    public static final String SOUND_MAP_KEY = "SOUND";
    public static final String MUSIC_MAP_KEY = "MUSIC";
